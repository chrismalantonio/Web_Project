    ...
    private void connect(boolean isTemple) {
        ...
        try {
            ...
            try {
                ...
                String url = "jdbc:mysql://localhost:3307/SP18_3344_tuf62546?user=tuf62546&password=ohthoope";

                // unless you are working from temple (wachman hall)
                if (isTemple) {
                    url = "jdbc:mysql://cis-linux2.temple.edu:3306/SP18_3344_tuf62546?user=tuf62546&password=ohthoope";
                }
